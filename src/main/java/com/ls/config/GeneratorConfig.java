...
public class GeneratorConfig {
    public static void main(String[] args) {
        ...
        FastAutoGenerator.create("jdbc:mysql://139.198.187.152:3306/INVENTORY?useUnicode=true&characterEncoding=UTF-8&useSSL=false", "root", "LINGsheng1026*")
                ...
                .packageConfig(builder -> {
                    ...
                    builder.addInclude("inventory"); // 设置需要生成的表名
